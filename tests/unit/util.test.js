...
describe('templateProcessor', () => {
	it('should return undefined if template processor get null sub rows', async () => {
...
describe('entityHelper', () => {
	...
	it('should return null if content path not exist', async () => {
		expect(getEntityByContextPath(''.split('/'))).to.not.exist;
	});

	it('should return false if composition not found', async () => {
