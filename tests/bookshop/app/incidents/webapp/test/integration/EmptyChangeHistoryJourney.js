...
sap.ui.define(["sap/ui/test/opaQunit"], function (opaTest) {
  ...
  var Journey = {
    run: function () {
      ...
      opaTest(
        "List Report page loads correctly",
      ...
      opaTest(
        "Navigate to 'Solar panel broken'",
        function (Given, When, Then) {
          When.onTheMainPage
            .onTable()
      ...
      opaTest(
        "Change History section exists on the Object Page",
        function (Given, When, Then) {
      ...
      opaTest(
        "Change History section is empty and has correct columns",
        function (Given, When, Then) {
      ...
      opaTest(
        "Change History can be collapsed and re-expanded",
        function (Given, When, Then) {
      ...
      opaTest(
        "Change History is hidden in draft mode; update status to 'Resolved'",
        function (Given, When, Then) {
      ...
      opaTest(
        "Change History shows update entry with 'Resolved'",
        function (Given, When, Then) {
