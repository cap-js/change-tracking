sap.ui.define(
  ...
  function (ObjectPage, OpaBuilder, Press, EnterText) {
    "use strict";

    // Stable IDs from Test Recorder
    var _sPrefix = "ns.incidents::IncidentsObjectPage--";
    var _sIdSeeMore =
      _sPrefix + "fe::FacetSubSection::ChangeHistoryFacet--seeMore";
    var _sIdSeeLess =
      _sPrefix + "fe::FacetSubSection::ChangeHistoryFacet--seeLess";
    var _sIdStatusVhi =
      _sPrefix +
      "fe::FormContainer::i18nDetails::FormElement::DataField::status_code::Field-edit-inner-vhi";
    var _sIdCustomerVhi =
      _sPrefix +
      "fe::FormContainer::GeneratedFacet1::FormElement::DataField::customer_ID::Field-edit-inner-vhi";
    var _sIdTitleField =
      _sPrefix +
      "fe::FormContainer::GeneratedFacet1::FormElement::DataField::title::Field-edit";
    var _sIdSaveButton =
      _sPrefix + "fe::FooterBar::StandardAction::Save";
    var _sIdConversationDeleteButton =
      _sPrefix +
      "fe::table::conversation::LineItem::i18nConversation1::StandardAction::Delete";
    var _sIdConversationCreateButton =
      _sPrefix +
      "fe::table::conversation::LineItem::i18nConversation1::StandardAction::Create";
    var _sIdConversationTable =
      _sPrefix +
      "fe::table::conversation::LineItem::i18nConversation1-innerTable";
      ...
      actions: {
        ...
        iEnterConversationMessage: function (sMessage) {
          return this.waitFor({
            ...
            errorMessage:
              "Could not find empty conversation message input",
          });
        },
        ...
        iUpdateConversationMessage: function (sOldMessage, sNewMessage) {
          return this.waitFor({
            ...
            errorMessage:
              "Could not find conversation message '" + sOldMessage + "'",
          });
        },
          ...
          return this.waitFor({
            ...
            matchers: function (oCheckBox) {
              ...
              if (
                !oTable ||
                !oTable.getId ||
                oTable.getId() !== _sIdConversationTable
              ) {
                return false;
              }
            ...
            errorMessage:
              "Could not select conversation row with message '" +
              sMessage +
              "'",
          });
        },
      ...
      assertions: {
        ...
        iSeeChangeHistoryColumns: function (aExpectedColumns) {
          return OpaBuilder.create(this)
            ...
            .check(function (aTables) {
              ...
              QUnit.assert.ok(
                true,
                "Change History columns: [" + aHeaders.join(", ") + "]"
              );
              return true;
            })
            .description(
        ...
        iSeeChangeHistoryEntries: function (iMinCount) {
          return OpaBuilder.create(this)
            ...
            .description(
              "Change History table has >= " + iMinCount + " entries"
            )
            .execute();
        },
