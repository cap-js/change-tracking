 ...
 */
function buildCompositionOfOneParentContext(compositionParentInfo, parentObjectIDs, refRow, model, childObjectIDExpr = null) {
 ...
 * @returns {{ insertSQL: string, parentEntityName: string, compositionFieldName: string, parentKeyExpr: string, parentLookupExpr: string }}
 */
function buildCompositionParentContext(compositionHierarchy, parentObjectIDs, refRow, model, childObjectID = null, buildFieldObjectIDFn = null) {
  ...
  if (parentKeyBinding.type === 'compositionOfOne') {
    return buildCompositionOfOneParentContext({ parentEntityName, compositionFieldName, parentKeyBinding }, parentObjectIDs, refRow, model, childObjectID);
  }
