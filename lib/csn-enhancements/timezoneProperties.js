...
const compositeKeyExpr = cds.env.requires?.db.kind === 'sqlite' ? compositeKeyExprSqlite : cds.env.requires?.db.kind === 'postgres' ? compositeKeyExprPG : compositeKeyExprHANA;
