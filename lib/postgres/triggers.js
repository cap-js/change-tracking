...
function buildFunctionBody(entity, columns, objectIDs, rootEntity, rootObjectIDs, model, compositionParentInfo = null, ancestorCompositionChain = []) {
	...
	// Build composition parent blocks if needed — pass child's object_id variable as the objectID for composition entries
	const createParentBlock = compositionParentInfo && !config?.disableCreateTracking ? buildCompositionParentBlock(compositionParentInfo, rootObjectIDs, 'create', model, ancestorCompositionChain, 'object_id') : '';
	const updateParentBlock = compositionParentInfo && !config?.disableUpdateTracking ? buildCompositionParentBlock(compositionParentInfo, rootObjectIDs, 'update', model, ancestorCompositionChain, 'object_id') : '';
	const deleteParentBlock = compositionParentInfo && !config?.disableDeleteTracking ? buildCompositionParentBlock(compositionParentInfo, rootObjectIDs, 'delete', model, ancestorCompositionChain, 'object_id') : '';
