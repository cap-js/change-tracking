 ...
 * 
 * @param {Array} entities - Array of { dbEntityName, mergedAnnotations }
 * @param {Object} model - CSN definitions object
 * @returns {Array} Array of { ID, locale, text } rows for i18n table
 */
