...
/**
 * Generate H2 trigger for composition of many
 */
...
/**
 * Generate key calculation Java code for composition of many
 */
...
/**
 * Generate root object ID calculation for composition of many
 */
...
/**
 * Generate CREATE body for composition of many
 */
function _generateCompOfManyCreateBody(targetEntity, rootEntity, compInfo, binding, rootObjectIDs) {
    ...
    const insertSQL = `INSERT INTO sap_changelog_Changes 
        (ID, ATTRIBUTE, VALUECHANGEDFROM, VALUECHANGEDTO, ENTITY, ENTITYKEY, OBJECTID, ROOTENTITY, ROOTENTITYKEY, ROOTOBJECTID, CREATEDAT, CREATEDBY, VALUEDATATYPE, MODIFICATION, TRANSACTIONID) 
        VALUES 
        (RANDOM_UUID(), '${compInfo.name}', NULL, ?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP(), CURRENT_USER(), 'cds.Composition', 'create', TRANSACTION_ID())`;
...
/**
 * Generate UPDATE body for composition of many
 */
function _generateCompOfManyUpdateBody(targetEntity, rootEntity, compInfo, binding, rootObjectIDs) {
    ...
    const insertSQL = `INSERT INTO sap_changelog_Changes 
        (ID, ATTRIBUTE, VALUECHANGEDFROM, VALUECHANGEDTO, ENTITY, ENTITYKEY, OBJECTID, ROOTENTITY, ROOTENTITYKEY, ROOTOBJECTID, CREATEDAT, CREATEDBY, VALUEDATATYPE, MODIFICATION, TRANSACTIONID) 
        VALUES 
        (RANDOM_UUID(), '${compInfo.name}', ?, ?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP(), CURRENT_USER(), 'cds.Composition', 'update', TRANSACTION_ID())`;
...
/**
 * Generate DELETE body for composition of many
 */
function _generateCompOfManyDeleteBody(targetEntity, rootEntity, compInfo, binding, rootObjectIDs) {
    ...
    const insertSQL = `INSERT INTO sap_changelog_Changes 
        (ID, ATTRIBUTE, VALUECHANGEDFROM, VALUECHANGEDTO, ENTITY, ENTITYKEY, OBJECTID, ROOTENTITY, ROOTENTITYKEY, ROOTOBJECTID, CREATEDAT, CREATEDBY, VALUEDATATYPE, MODIFICATION, TRANSACTIONID) 
        VALUES 
        (RANDOM_UUID(), '${compInfo.name}', ?, NULL, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP(), CURRENT_USER(), 'cds.Composition', 'delete', TRANSACTION_ID())`;
