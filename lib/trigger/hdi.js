...
function buildTriggerContext(entity, objectIDs, rootEntity, rootObjectIDs, rowRef, compositionParentInfo = null) {
	return {
		...
		parentLookupExpr: buildParentLookupExpr(compositionParentInfo, rowRef)
	};
}
 ...
 * When compositionParentInfo is provided with compInfo, this trigger will also create the composition changelog entry first.
 */
