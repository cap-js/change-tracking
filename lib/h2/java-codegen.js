...
/**
 * Returns the source of the shared abstract base class that every
 * generated trigger class extends. This is emitted once per project
 * next to the per-entity trigger classes.
 */
 ...
 * Generated by @cap-js/change-tracking. Do not edit.
 */
public abstract class ${TRIGGER_JAVA_BASE_CLASS} extends TriggerAdapter {

    /** Session variable holding the global skip flag. */
    protected static final String CT_SKIP_VAR = "${CT_SKIP_VAR}";
...
`;
  return { className: TRIGGER_JAVA_BASE_CLASS, source };
}
