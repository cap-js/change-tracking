...
/**
 * Write one `.java` file per generated trigger (plus the shared abstract base
 * class) into `srv/src/gen/java/<package>/`. The output directory is wiped
 * first so stale trigger classes from a previous build don't linger.
 *
