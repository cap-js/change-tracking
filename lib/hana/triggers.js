...
function generateCreateTrigger(entity, columns, objectIDs, rootObjectIDs, model, compositionParentInfo = null, ancestorCompositionChain = []) {
	// Build child's objectID expression for the composition parent entry
	const childObjectIDExpr = buildObjectIDExpr(objectIDs, entity, 'newTable', model);
	...
	const compositionParentContext = compositionParentInfo ? buildCompositionParentContext(compositionParentInfo, rootObjectIDs, 'create', 'newTable', model, ancestorCompositionChain, childObjectIDExpr) : null;
...
function generateUpdateTrigger(entity, columns, objectIDs, rootObjectIDs, model, compositionParentInfo = null, ancestorCompositionChain = []) {
	...
	// Build context for composition parent entry if this is a tracked composition target
	const compositionParentContext = compositionParentInfo ? buildCompositionParentContext(compositionParentInfo, rootObjectIDs, 'update', 'newTable', model, ancestorCompositionChain, childObjectIDExpr) : null;
	if (compositionParentContext) ctx.parentLookupExpr = compositionParentContext.parentLookupExpr;
...
function generateDeleteTriggerPreserve(entity, columns, objectIDs, rootObjectIDs, model, compositionParentInfo = null, ancestorCompositionChain = []) {
	// Build child's objectID expression for the composition parent entry
	const childObjectIDExpr = buildObjectIDExpr(objectIDs, entity, 'oldTable', model);
	const ctx = buildTriggerContext(entity, objectIDs, 'oldTable', model);

	// Build context for composition parent entry if this is a tracked composition target
	const compositionParentContext = compositionParentInfo ? buildCompositionParentContext(compositionParentInfo, rootObjectIDs, 'delete', 'oldTable', model, ancestorCompositionChain, childObjectIDExpr) : null;
	if (compositionParentContext) ctx.parentLookupExpr = compositionParentContext.parentLookupExpr;
