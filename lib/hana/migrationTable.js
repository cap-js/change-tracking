/**
 * Generates the .hdbmigrationtable artifact for the sap.changelog.Changes table
 */

function generateMigrationTable() {
	const sql = `== version=2
...
ALTER TABLE sap_changelog_Changes DROP (serviceEntity, parentEntityID, parentKey, serviceEntityPath, changeLog_ID);`;
	...
	return {
		name: 'sap.changelog.Changes',
		sql: sql,
		suffix: '.hdbmigrationtable'
	};
}

module.exports = { generateMigrationTable };
