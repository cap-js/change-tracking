...
function _generateCompositionBlock(comp) {
	const { childEntityName, parentEntityName, compositionField, childTableName, parentTableName, fkFields, childKeys, parentKeys, rootObjectIDs, childObjectIDs, grandParentCompositionInfo, grandParentKeys, grandParentTableName, grandParentObjectIDs } = comp;
